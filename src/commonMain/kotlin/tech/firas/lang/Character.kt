...
class Character {
    companion object {
         ...
         * @since Java 1.5
         */
        const val MIN_SURROGATE = tech.firas.lang.Character.Companion.MIN_HIGH_SURROGATE
         ...
         * @since Java 1.5
         */
        const val MAX_SURROGATE = tech.firas.lang.Character.Companion.MAX_LOW_SURROGATE
        ...
        fun isDigit(ch: Char): Boolean {
            return tech.firas.lang.Character.Companion.isDigit(ch.toInt())
        }
        ...
        fun isWhitespace(ch: Char): Boolean {
            return tech.firas.lang.Character.Companion.isWhitespace(ch.toInt())
        }
        ...
        fun digit(ch: Char, radix: Int): Int {
            if (radix < tech.firas.lang.Character.Companion.MIN_RADIX || radix > tech.firas.lang.Character.Companion.MAX_RADIX) {
        ...
        fun isHighSurrogate(ch: Char): Boolean {
            ...
            return ch >= tech.firas.lang.Character.Companion.MIN_HIGH_SURROGATE && ch < tech.firas.lang.Character.Companion.MAX_HIGH_SURROGATE + 1
        }
        ...
        fun isLowSurrogate(ch: Char): Boolean {
            return ch >= tech.firas.lang.Character.Companion.MIN_LOW_SURROGATE && ch < tech.firas.lang.Character.Companion.MAX_LOW_SURROGATE + 1
        }
        ...
        fun isSurrogate(ch: Char): Boolean {
            return ch >= tech.firas.lang.Character.Companion.MIN_SURROGATE && ch < tech.firas.lang.Character.Companion.MAX_SURROGATE + 1
        }
        ...
        fun charCount(codePoint: Int): Int {
            return if (codePoint >= tech.firas.lang.Character.Companion.MIN_SUPPLEMENTARY_CODE_POINT) 2 else 1
        }
        ...
        fun toCodePoint(high: Char, low: Char): Int {
            ...
            return (high.toInt() shl 10) + low.toInt() + (tech.firas.lang.Character.Companion.MIN_SUPPLEMENTARY_CODE_POINT
                    - (tech.firas.lang.Character.Companion.MIN_HIGH_SURROGATE.toInt() shl 10)
                    - tech.firas.lang.Character.Companion.MIN_LOW_SURROGATE.toInt())
        }
        ...
        fun codePointAt(seq: CharSequence, index: Int): Int {
            var _index = index
            val c1 = seq[_index]
            if (tech.firas.lang.Character.Companion.isHighSurrogate(c1) && ++_index < seq.length) {
                val c2 = seq[_index]
                if (tech.firas.lang.Character.Companion.isLowSurrogate(c2)) {
                    return tech.firas.lang.Character.Companion.toCodePoint(c1, c2)
                }
            }
            return c1.toInt()
        }
