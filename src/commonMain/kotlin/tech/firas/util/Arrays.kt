...
import tech.firas.lang.ArrayIndexOutOfBoundsException
...
class Arrays private constructor() {
    companion object {
        ...
        private fun rangeCheck(arrayLength: Int, fromIndex: Int, toIndex: Int) {
            ...
            if (fromIndex < 0) {
                throw tech.firas.lang.ArrayIndexOutOfBoundsException(fromIndex)
            }
            if (toIndex > arrayLength) {
                throw tech.firas.lang.ArrayIndexOutOfBoundsException(toIndex)
            }
        }
    }
}