    ...
    companion object {
        ...
        fun containsWhitespace(str: CharSequence?): Boolean {
            ...
            for (i in 0 until strLen) {
                if (tech.firas.lang.Character.isWhitespace(str[i])) {
                    return true
                }
            }
            return false
        ...
        fun trimWhitespace(str: String): String {
            ...
            while (beginIndex <= endIndex && tech.firas.lang.Character.isWhitespace(str[beginIndex])) {
                beginIndex += 1
            }

            while (endIndex > beginIndex && tech.firas.lang.Character.isWhitespace(str[endIndex])) {
                endIndex -= 1
            }
        ...
        fun trimAllWhitespace(str: String): String {
            ...
            for (i in 0 until len) {
                val c = str[i]
                if (!tech.firas.lang.Character.isWhitespace(c)) {
                    sb.append(c)
                }
            }
            return sb.toString()
